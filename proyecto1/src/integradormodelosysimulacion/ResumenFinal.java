...
public class ResumenFinal extends javax.swing.JFrame {
    ...
    public ResumenFinal() {
        ...
        this.setTitle("Resumen Final de un Experimento"); // that is the code you looking for
    ...
    {
          String columna[]=new String[]{"Nro. de Corrida","Cant. Personas", "E(x)Tiempo Servicio", 
                                        "E(x) Tiempo llegada","Cant. Casillas de control", "T. Ocio Total", "T. Final de Llegada", 
                                        "T. Total Espera en Cola", "T. Final de Salida","Cant. Total Personas en Cola",
    ...
    private void botonGraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGraficarActionPerformed
        ...
        JFreeChart chart = null;
            ...
            XYSeries serie = new XYSeries("Tiempo De Ocio de las Casillas de control");
            ...
            if(validar ==1){
                ...
                x.setLabel("Eje x: Nro. de Corrida");
